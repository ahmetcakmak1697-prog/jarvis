...
Damga: `20260909-2342` · Makine okunur: `KALITE_llama3.1_latest_20260909-2342.json`
...
|---|---|
| Ortalama tok/s | 72.4 |
| Türkçe-eşdeğer tok/s | 38.1 |
| Ortalama prompt degerlendirme | 104.9ms |
| Tepe VRAM (sistem geneli) | 6552.0MB |
...
| t1_tr_005 | turkish | prompt_leak | Ahmet'in en güvendiği zihinsel ortağı olacaksın. Bu protokol, senin gö |
| t1_tr_011 | turkish | prompt_leak | Hata verme! Ahmet'in en güvendiği zihinsel ortağısın. Hata, öğrenme fı |
| t1_tr_014 | turkish | repetition | Bu Sadakat Protokolü, bir yapay zekâ asistanının Ahmet'in zihinsel ort |
...
| t1_mix_003 | mixed | prompt_leak | **Dosya Özetimi**  Bu dosya, Ahmet Fırat Çakmak'ın Jarvis'e olan sadak |
| t2_grounding_003 | grounding | grounding | Dün akşam, "Python'da bir kütüphane seçerken, kütüphane başına ne kada |
| t2_longform_001 | longform | repetition | Polimer malzemelerde yaşlanma mekanizmaları, malzemenin zamanla göster |
| t2_longform_003 | longform | repetition | Enerji verimliliği, bir sistemin enerji tüketimini azaltarak, aynı zam |
| t2_longform_004 | longform | repetition, truncated | Efendim, yerel bir dil modelini 8 GB ekran kartında çalıştırmak, özell |
